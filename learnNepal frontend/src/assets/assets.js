...
export const dummyTestimonialData = [
  {
    name: 'Nishesh Biswash',
    image:
      'https://img.freepik.com/free-vector/student-avatar-concept-illustration_114360-174.jpg?w=2000',
    role: 'Student',
    rating: 5,
    feedback:
      'LearnNepal Website has been a game-changer for me. It provides excellent resources that helped me improve my skills. The teachers are incredibly supportive and always available to guide us!',
  },
  {
    name: 'Binit Koirala',
    image:
    ...
    rating: 4.5,
    feedback:
      'LearnNepal Website is an amazing platform for skill development. The courses are well-structured, and the teachers offer great insights and guidance throughout the learning journey!',
  },
  {
    name: 'Nikesh Regmi',
    image:
    ...
    rating: 5,
    feedback:
      'The LearnNepal Website has helped me gain valuable knowledge. The teachers are very helpful, making learning an enjoyable and enriching experience!',
  },
];
